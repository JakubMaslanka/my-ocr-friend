...
var TesseractService = (function () {
    function TesseractService() {
    }
    TesseractService.readImage = function (imagePath, onProgress) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        _a.sent();
                        return [2, worker.recognize(imagePath).then(function (value) { return value.data.text; })];
                }
            });
        });
    };
    TesseractService.readSeveralImages = function (imageList) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, []];
            });
