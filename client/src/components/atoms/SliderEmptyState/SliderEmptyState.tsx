...
import type { SliderEmptyStateProps } from "./SliderEmptyState.props";

const SliderEmptyState: React.FC<SliderEmptyStateProps> = ({ onClick }) => (
	<div className="flex h-full flex-col items-center justify-center text-center">
		...
		<div className="mt-6">
			...
			>
				<HiOutlineArrowNarrowLeft className="-ml-1 mr-2 h-5 w-5" aria-hidden="true" />
				Convert Image
			</button>
		</div>
	</div>
